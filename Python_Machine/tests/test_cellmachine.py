...
class TestImporting(TestCase):
    def test_import_manticore_v1(self):
        ...
        self.assertEqual(result, manticore_import_result, "Importing manticore with v3 encoding did not work")

    def test_import_manticore_v3(self):
        cellmachine = CellMachine()
